	...
	public void messaggio(Fattura fattura) {
		...
		switch (fattura.getStato()) {
		  case EMESSA:
		    ...
		    System.out.println(fattura.getCliente().getNomeContatto() + " " +fattura.getCliente().getCognomeContatto() + " La fattura " +fattura.getId() + " e' stata emessa");
		  ...
		  case INSOLUTA:
		    System.out.println(fattura.getCliente().getNomeContatto() + " " +fattura.getCliente().getCognomeContatto() + " La fattura " +fattura.getId() + " non e' stata pagata");
