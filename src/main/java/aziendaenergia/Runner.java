...
//				Tipo tipo = Tipo.SPA;
//
//				NewClientePayload clientePayload = new NewClientePayload(ragioneSociale, partitaIva, email,
//						dataInserimento, dataUltimoContatto, fatturatoAnnuale, pec, telefono, emailContatto,
//						nomeContatto, cognomeContatto, telefonoContatto, tipo, null, null);
//
